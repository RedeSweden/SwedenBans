package com.redesweden.swedenbans.sync;

import com.redesweden.swedenbans.util.DNSBL;
import com.redesweden.swedenbans.util.IPAddress;
import com.redesweden.swedenbans.util.InputStreamWrapper;
import com.redesweden.swedenbans.util.OutputStreamWrapper;
    ...
    public ClientToServerConnection(final String host, final int port, final String pass) {
                        ...
                        do {
                            ...
                            try {
                                ...
                                if (c == null) {
                                    ...
                                    final SyncBanManager sbm = (SyncBanManager) SwedenBans.instance.getBanManager();
                                    sbm.startSync();
                                    c.run(p);
                                    sbm.stopSync();
                                }
        ...
        final Command announce = new Command() {
            public void run(final Packet prop) {
                ...
                SwedenBans.instance.getBanManager().announce(msg, silent, null);
            }
        };
        ...
        final Command unwarn = new Command() {
            public void run(final Packet prop) {
                ...
                final List<Warn> warnings = SwedenBans.instance.getBanManager().getWarnings(name);
                if (warnings == null) {
                    return;
                }
                SwedenBans.instance.getBanManager().deleteWarning(name, warnings.get(warnings.size() - 1));
            }
        };
        ...
        final Command setip = new Command() {
            public void run(final Packet prop) {
                ...
                final String name = prop.get("name");
                SwedenBans.instance.getBanManager().logIP(name, ip);
            }
        };
        ...
        final Command setname = new Command() {
            public void run(final Packet prop) {
                ...
                SwedenBans.instance.getBanManager().logActual(actual, actual);
            }
        };
        this.commands.put("setname", setname);
        final Command dnsbl = new Command() {
            public void run(final Packet prop) {
                if (SwedenBans.instance.getBanManager().getDNSBL() == null) {
                    return;
                }
                final String ip = prop.get("ip");
                ...
                SwedenBans.instance.getBanManager().getDNSBL().setRecord(ip, r);
            }
        };
        ...
        final Command ban = new Command() {
            public void run(final Packet props) {
                ...
                SwedenBans.instance.getBanManager().ban(name, reason, banner);
            }
        };
        ...
        final Command ipban = new Command() {
            public void run(final Packet props) {
                ...
                final String banner = props.get("banner");
                final String reason = props.get("reason");
                SwedenBans.instance.getBanManager().ipban(ip, reason, banner);
            }
        };
        ...
        final Command tempipban = new Command() {
            public void run(final Packet props) {
                ...
                SwedenBans.instance.getBanManager().tempipban(ip, reason, banner, expires);
            }
        };
        ...
        final Command tempban = new Command() {
            public void run(final Packet props) {
                ...
                final String reason = props.get("reason");
                final long expires = Long.parseLong(props.get("expires"));
                SwedenBans.instance.getBanManager().tempban(name, reason, banner, expires);
            }
        };
        ...
        final Command unban = new Command() {
            public void run(final Packet props) {
                final String name = props.get("name");
                SwedenBans.instance.getBanManager().unban(name);
            }
        };
        ...
        final Command unbanip = new Command() {
            public void run(final Packet props) {
                final String ip = props.get("ip");
                SwedenBans.instance.getBanManager().unbanip(ip);
            }
        };
        ...
        final Command mute = new Command() {
            public void run(final Packet props) {
                ...
                final String banner = props.get("banner");
                final String reason = props.get("reason");
                SwedenBans.instance.getBanManager().mute(name, banner, reason);
            }
        };
        ...
        final Command tempmute = new Command() {
            public void run(final Packet props) {
                ...
                final String reason = props.get("reason");
                final long expires = Long.parseLong(props.get("expires"));
                SwedenBans.instance.getBanManager().tempmute(name, banner, reason, expires);
            }
        };
        ...
        final Command unmute = new Command() {
            public void run(final Packet props) {
                final String name = props.get("name");
                SwedenBans.instance.getBanManager().unmute(name);
            }
        };
        ...
        final Command warn = new Command() {
            public void run(final Packet props) {
                ...
                final String banner = props.get("banner");
                final String reason = props.get("reason");
                SwedenBans.instance.getBanManager().warn(name, reason, banner);
            }
        };
        ...
        final Command clearwarnings = new Command() {
            public void run(final Packet props) {
                final String name = props.get("name");
                SwedenBans.instance.getBanManager().clearWarnings(name);
            }
        };
        ...
        final Command addhistory = new Command() {
            public void run(final Packet props) {
                ...
                final String name = props.get("name");
                final String banner = props.get("banner");
                SwedenBans.instance.getBanManager().addHistory(name, banner, message);
            }
        };
        ...
        final Command rangeban = new Command() {
            public void run(final Packet props) {
                ...
                SwedenBans.instance.getBanManager().ban(rb);
            }
        };
        ...
        final Command unrangeban = new Command() {
            public void run(final Packet props) {
                ...
                SwedenBans.instance.getBanManager().unban(rb);
            }
        };
        ...
        final Command whitelist = new Command() {
            public void run(final Packet props) {
                ...
                SwedenBans.instance.getBanManager().setWhitelisted(name, white);
            }
        };
        ...
        final Command kick = new Command() {
            public void run(final Packet props) {
                final String name = props.get("name");
                final String reason = props.get("reason");
                SwedenBans.instance.getBanManager().kick(name, reason);
            }
        };
        ...
        final Command kickip = new Command() {
            public void run(final Packet props) {
                final String ip = props.get("ip");
                final String reason = props.get("reason");
                SwedenBans.instance.getBanManager().kickIP(ip, reason);
            }
        };
        ...
        final Command setimmunity = new Command() {
            public void run(final Packet props) {
                ...
                SwedenBans.instance.getBanManager().setImmunity(name, immune);
            }
        };
