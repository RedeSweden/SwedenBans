...
import com.redesweden.swedenbans.commands.bridge.MySQLBridge;
import com.redesweden.swedenbans.commands.bridge.SQLiteBridge;
import com.redesweden.swedenbans.commands.bridge.VanillaBridge;
...
public class MBExportCommand extends CmdSkeleton
{
    public MBExportCommand() {
        super("mbexport", "swedenbans.export");
        this.namePos = -1;
    }
